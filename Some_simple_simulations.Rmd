...
par(mfrow=c(2,2))
simksseq(p=0.001,k=k,s=0.98^(1+log(k)),npers=2000)
simksseq(p=0.005,k=k,s=0.98^(1+log(k)),npers=2000)
k=c(1,2,4,8,16,32)
simksseq(p=0.01,k=k,s=0.98^(1+log(k)),npers=2000)
simksseq(p=0.5,k=k,s=0.98^(1+log(k)),npers=2000)
```
